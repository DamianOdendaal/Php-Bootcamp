...
<html>
	...
	<body>
		...
		<table>
				<tr>
                    <td><img src = "https://shop.herbalremediesil.com/wp-content/uploads/2019/01/flower-bermudatriangle-img-2865-1.jpg" height = "20%" width = "30%"><br/><span>Laughing Grass</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
				...
				<tr>
                    <td><img src = "https://www.mailorder-marijuana.ca/wp-content/uploads/2018/10/IMG_0410.jpg" height = "20%" width = "30%"><br/><span>Brainfuck</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
