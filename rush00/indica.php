	...
	<body>
		...
		<table>
				<tr>
					...
					<td><img src =  "http://catnews.org/weed/wp-content/uploads/2017/02/202-5.jpg" height = "20%" width = "30%"><br/><span>Kryptochronic</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
