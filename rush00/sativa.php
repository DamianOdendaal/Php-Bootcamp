	...
	<body>
		...
		<table>
				<tr>
                    ...
                    <td><img src = "https://cdn.greenrush.com/media/8/4/8/1576848/triangle-kush-24-thc-5297.jpg" height = "20%" width = "30%"><br/><span>Barck O Bubba</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
				...
				<tr>
					...
					<td><img src = "https://i2.wp.com/www.420curefam.com/wp-content/uploads/2018/05/420curefam-Sour-Diesel-Marijuana.jpg?fit=1292%2C969&ssl=1" height = "20%" width = "30%"><br/><span>Cannabista</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
                    <td><img src = "https://cdn.shopify.com/s/files/1/1090/7524/products/flower-space-nugs-high-potency-cannabis-2.jpg?v=1544594796" height = "20%" width = "30%"><br/><span>Alaskan Ice</br>R49.99</br><button>add to cart<i class="fa fa-shopping-cart" style="font-size:24px;"></i></button></span></td>
                </tr>
                <tr>
